...
model: opus
color: blue
tools: Read, Glob, Grep, Edit, Write, Bash(${CLAUDE_PLUGIN_ROOT}/scripts/workflow-io/get-report.sh), Task, Skill
skills: tdd-workflow, test-best-practices, code-style, python
---
