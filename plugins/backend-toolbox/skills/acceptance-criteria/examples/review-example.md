...
> "Add user authentication to the app. Users should be able to sign up with email/password, log in, and log out. Show a
> welcome message with their name when logged in."
...
The core authentication flow (signup, login, logout) is complete. However, instruction #4 is only partially met - the
welcome message shows email instead of name as requested. To fully satisfy the request:
